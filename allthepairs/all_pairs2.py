from allthepairs import pairs_storage
from allthepairs.combinatorics import xuniqueCombinations
...
class all_pairs2:
    ...
    def resort_working_array( self, chosen_values_arr, num ):
        ...
        def compare(a, b):
            return (a.weights > b.weights) - (a.weights < b.weights)
        ...
        self.__working_arr[num].sort(key=cmp_to_key(compare))
